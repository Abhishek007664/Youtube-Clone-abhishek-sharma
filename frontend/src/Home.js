...
import techburner from './images/techburner.jpg'
        ...
        <div>
            ...
            <div class="main-section">
                <div class="main-left">
                    ...
                    <button class="yt-side-button">
                        <img src={techburner} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">Tech Burner</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={speed} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">liveSpeedy</span>
                    </button>
                </div>
